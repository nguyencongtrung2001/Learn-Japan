...
export default function KanaToRomajiPage() {
      ...
      {phase !== "quiz" && (
        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold mb-2">
            ...
            <span className="gradient-text">Kana → Romaji</span>
          </h1>
          <p className="text-foreground-muted text-sm">
            Xem ký tự tiếng Nhật và nhập cách đọc bằng Romaji
          </p>
        </div>
      )}
        ...
        <div className="text-center animate-fade-in-up">
          <div className="glass-card p-8 sm:p-10 max-w-md mx-auto mb-8">
            ...
            <p className="text-foreground-muted text-sm mb-6">
              {sessionCorrect / (sessionCorrect + sessionIncorrect) >= 0.8
                ? "Tuyệt vời! Bạn đã nắm vững phần lớn ký tự!"
                : sessionCorrect / (sessionCorrect + sessionIncorrect) >= 0.5
                ? "Tốt lắm! Hãy tiếp tục luyện tập nhé!"
                : "Đừng nản, luyện tập thêm sẽ giỏi hơn!"}
            </p>
